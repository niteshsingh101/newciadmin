	...
	<script src="<?php echo base_url();?>/front_assets/js/parallax.min.js"></script>
	<script src="<?php echo base_url();?>/front_assets/js/wow.min.js"></script>
	<script src="<?php echo base_url();?>/front_assets/js/jquery.easing.min.js"></script>
	<script type="text/javascript" src="<?php echo base_url();?>/front_assets/js/fliplightbox.min.js"></script>
	<script src="<?php echo base_url();?>/front_assets/js/functions.js"></script>
    <script src="<?php echo base_url();?>/front_assets/contactform/contactform.js"></script>
     <script>
	 $(document).ready(function(){
		 
		//alert("call");
        $("img[class=parallax-slider]").attr("src","<?php echo base_url();?>/front_assets/img/3.png");		
	 });
	 </script>
</body>
</html>